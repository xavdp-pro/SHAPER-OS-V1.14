 ...
 * once used — creating a vault nobody reads when that file was absent.
 ...
 * writes that pointer into software/.env only when it creates the file. A vault that does
...
// Anything else halts naming the line. The file only fills what the shell
// left unset.
