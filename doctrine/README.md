...
| **3** | [`FRACTAL-ARCHITECTURE-WORDPRESS-SAAS-EXAMPLE.md`](./FRACTAL-ARCHITECTURE-WORDPRESS-SAAS-EXAMPLE.md) | **The fractal demonstrated by example**: from a single-child WordPress to a 50-site Manager and a three-level Super-SaaS. |
...
| **7** | [`DOCUMENT-PIPELINE.md`](./DOCUMENT-PIPELINE.md) | **Document understanding**: the page as the unit, three witnesses (native text, OCR, vision), deskewing and legibility, type recognition then business handlers, multiplexing, state in the database, open sources. Brick intent: [`brick-pipeline`](https://github.com/xavdp-pro/SHAPER-OS-BRICKS-V1.10). |
